import { Avatar, Badge, Card, MetricCard, Page, PageHeader, PageSection, Text } from '@ankhorage/zora';
...
export default function ProfileScreen() {
  return (
    ...
    >
      <PageSection title="Creator profile" description="A profile route composed from public ZORA exports.">
        <Card
          title="Ava Studio"
      ...
      <PageSection title="Audience">
        <MetricCard label="Followers" value="1.8k" delta="+8%" deltaTone="success" description="Last 30 days" />
        <MetricCard label="Saved posts" value="243" description="Across public groups" />
        <MetricCard label="Replies" value="612" delta="+14" deltaTone="primary" description="This month" />
      </PageSection>
    </Page>
  );
}
