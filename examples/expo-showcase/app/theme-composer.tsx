          ...
          <PageSection title="Live preview">
            ...
            >
              <Stack gap="m">
                ...
                <Card
                  ...
                  footer={
                    <Stack direction="row" gap="s" wrap="wrap">
                      ...
                      <Badge tone="success" emphasis="soft">Success</Badge>
                      <Badge tone="warning" emphasis="soft">Warning</Badge>
                      <Badge tone="danger" emphasis="outline">Danger</Badge>
                    </Stack>
                  }
                >
                  <Stack gap="s">
                ...
                <Card title="Form controls" description="Inputs and textareas should stay readable on themed surfaces." tone="subtle">
                  <Stack gap="s">
                    <Input value={theme.primaryColor} />
                    <Textarea value="Theme notes, accessibility observations, and recipe QA details." rows={3} />
                    <Stack direction="row" gap="s" wrap="wrap">
                      <Button tone="primary">Primary action</Button>
                      <Button tone="neutral" emphasis="soft">Secondary</Button>
                      <Button tone="danger" emphasis="ghost">Danger ghost</Button>
                    </Stack>
                  </Stack>
                </Card>
              </Stack>
