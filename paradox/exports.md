...
| confirmColor      | property | `"danger" \| "primary" \| "secondary" \| "tertiary" \| "quaternary" \| "neutral" \| "success" \| "warning" \| "error" \| "info" \| undefined` | no       |             |
...
| icon        | property | `import("@ankhorage/surface").IconSource \| undefined`       | no       |             |
| id          | property | `string`                                                     | yes      |             |
| intent      | property | `import("@ankhorage/surface").MenuActionIntent \| undefined` | no       |             |
...
- `(props: import("./types").MenuProps) => React.JSX.Element`
  - props: `import("./types").MenuProps`
...
| children           | property | `React.ReactNode`                                                                                                                                         | no       |             |
| color              | property | `Responsive<"danger" \| "primary" \| "secondary" \| "tertiary" \| "quaternary" \| "neutral" \| "success" \| "warning" \| "error" \| "info"> \| undefined` | no       |             |
...
| deltaColor        | property | `"danger" \| "primary" \| "secondary" \| "tertiary" \| "quaternary" \| "neutral" \| "success" \| "warning" \| "error" \| "info" \| undefined` | no       |             |
| description       | property | `React.ReactNode`                                                                                                                             | no       |             |
| icon              | property | `import("@ankhorage/surface").IconSource \| undefined`                                                                                        | no       |             |
| interactionPolicy | property | `InteractionPolicy \| undefined`                                                                                                              | no       |             |
| label             | property | `React.ReactNode`                                                                                                                             | yes      |             |
...
| themeId                | property | `string \| undefined`                                                                                                                         | no       |             |
| thickness              | property | `number \| undefined`                                                                                                                         | no       |             |
| trackColor             | property | `"danger" \| "primary" \| "secondary" \| "tertiary" \| "quaternary" \| "neutral" \| "success" \| "warning" \| "error" \| "info" \| undefined` | no       |             |
| value                  | property | `number`                                                                                                                                      | yes      |             |
...
| id          | property | `string`                                                                                                                                      | yes      |             |
| meta        | property | `React.ReactNode`                                                                                                                             | no       |             |
| status      | property | `"danger" \| "primary" \| "secondary" \| "tertiary" \| "quaternary" \| "neutral" \| "success" \| "warning" \| "error" \| "info" \| undefined` | no       |             |
| testID      | property | `string \| undefined`                                                                                                                         | no       |             |
| title       | property | `React.ReactNode`                                                                                                                             | yes      |             |
...
Kind: `unknown`
Module: `src/metadata/bindableComponentMeta.ts`
Source: `src/metadata/bindableComponentMeta.ts:514:1`
